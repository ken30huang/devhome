                ...
                <div class="card-body">
                    ...
                    <div class="card-text">
                        <ul class="series_list">
                            ...
                            <li><a href="<?php echo module_url('/blog/detail/'.$blog['c_alias']);?>"><?php echo $blog['c_title']?></a></li>
                            <?php endforeach;?>
                        </ul>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-text">
                        <ul class="series_list">
                            ...
                            <li><a href="<?php echo module_url('/series/detail/'.$series['c_id']);?>" target="_blank"><?php echo $series['c_title']; ?></a></li>
                            <?php endforeach;?>
                        </ul>
                    </div>
                    <a href="<?php echo module_url('/series/');?>" class="btn btn-primary">更多系列文档</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo module_url('/demos/front?demo_id='.$demo['demo_id']);?>" class="card-link">查看效果</a>
                </div>
            </div>
        </div>
        <?php endforeach;?>
