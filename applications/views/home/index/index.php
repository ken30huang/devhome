<div class="banner-text-w3ls" id="knowledge">
    <div class="container">
        <div class="mx-auto text-center">
            <h3>每日知识点</h3>
            <p class="banp mx-auto mt-3"><b><?php echo $wiki_row['c_title']; ?></b> : <?php echo $wiki_row['c_cont']; ?></p>
            <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="#about" role="button">知识来源</a>
            <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="#about" role="button">更多知识点</a>
        </div>
    </div>
</div><!-- news -->
<div class="news" id="news">
    <h3 class="w3_head mb-4 text-left"> 开发日志</h3>
    <p class="iner mt-md-5 text-left"> 记录开发和学习的点点滴滴</p>
    <div class="row news-grids-left mt-5">
        <div class="col-lg-5 news_top">
            <img src="/applications/layouts/<?php echo $ui_path;?>/images/g1.jpg" alt="news image" class="img-fluid">
        </div>
        <div class="col-lg-7 news_top1">
            <h5><a href="javascript:;">Nulla pellentesque</a></h5>
            <p class="mt-3">Integer eu ante ornare amet commetus vestibulum blandit integer in curae ac faucibus
                integer adipiscing ornare amet.</p>
        </div>
    </div>
    <div class="row news-grids-middle">
        <div class="col-lg-5 news_top">
            <img src="/applications/layouts/<?php echo $ui_path;?>/images/g2.jpg" alt="news image" class="img-fluid">
        </div>
        <div class="col-lg-7 news_top1">
    ...
    <div class="row news-grids-right">
        <div class="col-lg-5 news_top">
            <img src="/applications/layouts/<?php echo $ui_path;?>/images/g3.jpg" alt="news image" class="img-fluid">
        </div>
        <div class="col-lg-7 news_top1">
            <h5>Nulla pellentesque</h5>
            <p class="mt-3">Integer eu ante ornare amet commetus vestibulum blandit integer in curae ac faucibus
...
<section class="wedo" id="contact">
    ...
    <p class="iner mt-md-5 text-left"> Nunc fermentum adipiscing tempor cursus nascetur adipiscing adipiscing.
        Primis aliquam mus lacinia lobortis.Nunc fermentum adipiscing tempor cursus nascetur adipiscing
        adipiscing. </p>
