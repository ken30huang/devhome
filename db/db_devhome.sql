...
-- ----------------------------
INSERT INTO `dh_code_file` VALUES ('1', 'index.html', '1', '<div id=\"example\" class=\"jqcloud\" style=\"width: 550px; height: 350px;\"></div>', 'javascript', '0', 'html');
...
INSERT INTO `dh_content` VALUES ('140', 'collect', '30', 'Smashing Magazine', null, null, null, 'https://www.smashingmagazine.com/', null, '', null, '2019-08-08 09:26:22', '0', '设计,开发', null, null, '0', null);
...
-- Records of dh_demo
-- ----------------------------
INSERT INTO `dh_demo` VALUES ('1', 'JQCloud标签云', '使用jQCloud插件生成标签云，可根据不同的权重区分每个标签的样式', '10', '0', '', '1', null);
